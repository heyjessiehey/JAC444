...
public class MyJFrame extends JFrame{
	...
	public void addStudent(){	
		...
		submitButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent event){
				...
				//clear texts on textfields and Object initialize null
	...
	public void getData() {
		try {
			...
			stmt.executeUpdate("insert into Students " + "values(" + student.getStdID() + ", '" + student.getFirstName() + "', '" + 
	...
	public void showStudent(){			
		...
		try{
			// Get connection and statements objects
			con = DriverManager.getConnection(Values.URL, Values.USER_NAME, Values.PASS_WORD);
			stmt = con.createStatement();
			
			// Execute JDBC command and Get the result
			ResultSet rs = stmt.executeQuery("select stdID, firstName, lastName, course from Students");
			...
			while(rs.next()){
				...
				p.add(new JLabel (String.valueOf(id)));
				p.add(new JLabel (fname));
				p.add(new JLabel (lname));
